...
class PolicyService(Protocol):
    ...
    def validate_document_extraction(self, extraction: DocumentExtraction, artifact: Artifact) -> None: ...
...
class AgentService(Protocol):
    async def document_evidence(self, artifact: Artifact, *, context: WorkflowContext) -> DocumentExtraction: ...
...
class CityDocumentWorkflow:
    ...
    async def run(self, event: SourceEvent, *, trace_id: str) -> WorkflowResult:
        ...
        try:
            ...
            # This outline intentionally preserves no raw source/model content in exception messages.
