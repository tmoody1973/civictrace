...
|---|---|---|
| `records/tid121-project-plan-2024.pdf` | Project Plan, TID 121 — the Promise. Common Council file 240382, passed 2024-07-02. 31 pp. | Legistar matter 68373, attachment 223678. sha256 `7097a1ba…aefe1` |
| `records/tid-annual-report-2024.pdf` | 2024 Annual TID Report (DCD communication). File 250623, placed on file 2025-07-31. 164 pp. TID 121 is on pp. 163–164. | Matter 71523, attachment 237082. sha256 `a2058b5f…124e6` |
| `records/tid121-amendment-1-2026.pdf` | Amendment #1 to the TID 121 Project Plan. File 260433, passed 2026-07-14. 15 pp. | Matter 74415, attachment 248545. sha256 `0c5ce45b…706a41` |
...
```bash
cd backend/tests/fixtures/milwaukee-city-promise-ledger-demo-v1/records && shasum -a 256 *.pdf
# expected:
